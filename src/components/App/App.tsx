...
function App() {
  ...
  const url = `https://api.openweathermap.org/data/2.5/forecast?q=${location}&lang=fr&units=metric&appid=${API_KEY}`;
  ...
  return (
    <div className="w-full h-full relative">
      <div className="flex justify-center py-4 ">
        <div className="flex text-lg bg-purple-500 w-[400px] rounded-3xl">
          <input
            type="text"
